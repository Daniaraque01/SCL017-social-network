...
export default () => {
  ...
  <nav id="navbar-feed">
    <div id="side-nav" >
        <a href="#/feed" id="home-btn" class="redirect"><img class="vector" src = "SCL017-social-network/css/img_app/vector_home.png"></img></a>
        <a id="match-btn" class="macth-redirect"><img class="match-vector" src = "SCL017-social-network/css/img_app/relationship.png"></img></a>
        <a id="search-btn" class="redirect"><img class="vector" src = "SCL017-social-network/css/img_app/vector_search.png"></img></a>
        <a href="#/profile" id="profile-btn" class="redirect"> <img class="vector" src = "SCL017-social-network/css/img_app/vector_profile.png"></a>
    </div>
  </nav>
  ...
  <nav id="navbar-feed-laptop">
    ...
    <div id="side-nav">
        <a href="#/profile"  class="editBtn"><img class="vector" src = "SCL017-social-network/css/img_app/vector_edit_pink.png"></img></a>
        <a href="#/profile" id="profile-btn-white" class="redirect"> <img class="vector" src = "SCL017-social-network/css/img_app/vector_profile.png"></a>
    </div>
  </nav>
  ...
  <section id="feed-section">
    <div>
      <div id="header-logo">
        <div id="chevron-logo">
          <img class="chevron-img" src="SCL017-social-network/css/img_app/chevronLS.png"</img>
        </div>
    ...
    <div id="filter-icons">
        <div id="search-help">
            <a><img class="search-help" src = "SCL017-social-network/css/img_app/help.png""></a>
            <p>Ayuda técnica</p>
        </div>
        <div id="search-memes">
            <a><img class="search-memes" src = "SCL017-social-network/css/img_app/memes.png""></a>
            <p>Publica y ríete</p>
        </div>
        <div id="search-ghpage">
            <a><img class="search-ghpage" src = "SCL017-social-network/css/img_app/GHpage.png""></a>
            <p>Proyecto Github</p>
        </div>
        <div id="search-resources">
            <a><img class="search-resources" src = "SCL017-social-network/css/img_app/resources.png""></a>
            <p>Información útil</p>
        </div>
        <div id="search-team">
            <a><img class="search-team" src = "SCL017-social-network/css/img_app/team.png""></a>            
  ...
  <div class="modal-match" id="modal-match">
    ...
    <div class="modal">
        ...
        <div class="tool-bar">
          <img id="text-icon" class="textIcon" src="SCL017-social-network/css/img_app/vector_text.png"></img>
          <img id="link-icon" class="linkIcon"src="SCL017-social-network/css/img_app/vector_link.png"></img>
          <img id="addImg-icon" class="imgIcon" src="SCL017-social-network/css/img_app/vector_image.png"></img>
        </div>  
      </div>
    </div>
  </div>            
  ...
  document.addEventListener('DOMContentLoaded', async (e) => {
    ...
    //     post.id = doc.id;
        ...
        //         <a><img class="btn-edit" id="edit-post" src= "SCL017-social-network/css/img_app/edit.png" data-id="${post.id}"></img></a>
        //       </div>
        //     </div>
        //     `;
      ...
      querySnapshot.forEach((doc) => {
        ...
        postContainer.innerHTML += `
            <div class="each-post">
              ...
              <div class="interaction-bar">
                <div>
                  <img class="btn-like" id="btn-like" src="SCL017-social-network/css/img_app/vector_like.png" data-id="${post.id}"></img>
                  <p class="number-likes" id="counter-likes" data-id="${post.id}">${post.like.length} </p>
                </div>
                <a><img class="btn-edit" id="edit-post" src= "SCL017-social-network/css/img_app/edit.png" data-id="${post.id}"></img></a>
                <a><img class="btn-delete" src= "SCL017-social-network/css/img_app/trash.png"data-id="${post.id}"></img></a>
              </div>
            </div>
            `;
